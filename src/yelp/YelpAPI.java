...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "wtGtKd-K0NiW-XhPZJFCkA";
    private static final String CONSUMER_SECRET = "Y5uhO3CmR7EKjptyiABPSqNRIwc";
    private static final String TOKEN = "4zEtE2f9RkLmkWP4RaTvQE0PQCtG-z1E";
    private static final String TOKEN_SECRET = "U7Dm50ECNJKrV3zkgD9DpRNFMzE";
    ...
    public String searchForBusinessesByLocation(double lat, double lon) {
   	 OAuthRequest request = new OAuthRequest(Verb.GET, "http://" + API_HOST
   			 + SEARCH_PATH);
   	 request.addQuerystringParameter("term", DEFAULT_TERM);//like ?term=...
