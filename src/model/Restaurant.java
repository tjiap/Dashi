...
public class Restaurant {
	...
	// Java object --> JSON object For front-end use
	...
	// "abcd"cdef" --> "abcd\"cdef"
	// \represents the char behind it is special character, not functional
	// character
	...
	public static String jsonArrayToString(JSONArray array) {
		/*
		 * [ "Chinese", "Japanese" ] --> "Chinese, Japanese" JSON array -->
		 * string
		 */
